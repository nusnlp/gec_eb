...
def get_parser(desc, default_task="translation"):
    ...
    parser.add_argument('--update-weight', type=int, default=-1,
                        help='update language sampling every N step')
    parser.add_argument('--hard-sample', action='store_true',
                        help='use hard sample or not')
    parser.add_argument('--just-two', action='store_true',
                        help='jsut the beta network')
    parser.add_argument('--just-one', action='store_true',
                        help='jsut the alpha network')
    parser.add_argument('--pretrain', action='store_true',
                        help='pretrain two networks')
    parser.add_argument('--normalize', action='store_true',
                        help='normalize the reward')
    parser.add_argument('--just-sim', action='store_true',
                        help='just use sim')
    ...
    # original data actor parsers
    parser.add_argument('--data-actor', type=str, default=None,
                        help='type of data actor [base|ave_emb|only_grad|interpolate_grad]')
    parser.add_argument('--hu-update', type=str, default=None,
                        help='Use hu\'s method or not')
    parser.add_argument('--just-phi', type=str, default=None,
                        help='Just update phi or not')
    parser.add_argument('--predict-path', type=str, default=None,
                        help='teacher forcing prediction')
    parser.add_argument('--test-seperate', type=str, default=None,
                        help='sepearte gradient computation')
    parser.add_argument('--accumulate', type=str, default=None,
                        help='sepearte gradient computation')
    parser.add_argument('--new-method', type=str, default=None,
                        help='use new method')
    parser.add_argument('--reverse', type=str, default=None,
                        help='Phi before theta or not')
    parser.add_argument('--slash-s', type=str, default=None,
                        help='use _s method or not')
    parser.add_argument('--pretrained-data-actor-path', type=str, default=None,
                        help='data actor\'s path')
    parser.add_argument('--w-decay', type=float, default=10.0,
                        help='weight decay for hu\'s embedding')
    parser.add_argument('--data-actor-path', type=str, default=None,
                        help='data_actor_save_path')
    parser.add_argument('--bohb', type=str, default=None,
                        help='bohb hyper-parameter tuning')
    parser.add_argument('--weight-list', nargs="+", default=None,
                        help='bohb hyper-parameter tuning')
    parser.add_argument('--pretrain-model-steps', type=int, default=0,
                        help='pretrain the model for how may steps')
    parser.add_argument('--pretrain-data-actor-ori', type=str, default=None,
                        help='pretrain the data actor for ori')
    parser.add_argument('--pretrain-data-actor-nos', type=str, default=None,
                        help='pretrain the data actor for nos')
    ...
    parser.add_argument('--data-actor-lr', type=float, default=0.01,
                        help='lr for optimizing original data actor')
    parser.add_argument('--nos-data-actor-lr', type=float, default=0.01,
                        help='lr for optimizing noisy data actor')
    parser.add_argument('--data-actor-optim-step', type=int, default=1,
                        help='number of steps to optimize data actor')
    parser.add_argument('--test', action='store_true',
                        help='test the loss function correct or not')
    parser.add_argument('--pretrain-first', action='store_true',
                        help='pretrain first without training the data actor')
    parser.add_argument('--number-of-data-scorers', type=int, default=2,
                        help='number of data scorers to use')
    parser.add_argument('--csv-path', type=str, default="csv",
                        help='path to save the csv file')
    parser.add_argument('--ori-weight-trainer', type=float, default=0.5,
                        help='weight to the original')
    parser.add_argument('--nos-temperature', type=float, default=1.0,
                        help='temperature of the softmax for noisy data actor')
    parser.add_argument('--ori-temperature', type=float, default=1.0,
                        help='temperature of the softmax for original data actor')
